...
<table class="tariffs-panel" cols="3" cellspacing="0" cellpadding="0" frame="void">
    ...
    <% if (!string.IsNullOrEmpty(SalesMail))
       { %>
    <tfoot>
        <tr>
            <td class="tariff-needmore" colspan="3">
                <%= Resource.TariffMore %>
                <a class="link underline gray" href="mailto:<%= SalesMail %>"><%= Resource.ContactUs %></a>
            </td>
        </tr>
    </tfoot>
    <% } %>
...
<div class="tariffs-button-block">
...
<% if (Partner == null)
   { %>
<div class="tariff-help">
    <span class="header-base-medium">
        <%= Resource.TariffAnyQuestions %></span>
    <br />
