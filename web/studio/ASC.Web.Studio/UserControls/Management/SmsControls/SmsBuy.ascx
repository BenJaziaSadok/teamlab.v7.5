...
<%= string.Format(Resource.SmsCount, "<b>" + StudioSmsNotificationSettings.SentSms + "</b>", StudioSmsNotificationSettings.PaidSms) %>

<% if (CanBuy)
   { %>
<div style="display: inline-block; margin-left: 8px;">
    <a id="smsBuy" class="baseLinkAction link plus blue"><%= Resource.SmsBuyHeader %></a>
