...
//Video dialog
DlgYouTubePageURL	: "Адрес YouTube страницы:",
DlgVideoURL			: "URL (поддерживается только формат FLV):",
DlgVidoUploadTitle	: "Загрузить (поддерживается только формат FLV):",

//Fck resizer
RestoreDefaultEditorSize	: "Нажмите для восстановления исходного размера редактора",
