    ...
    <sc:Container runat="server" ID="_emailChangerContainer">
        ...
        <Body>
            <div id="studio_emailOperationContent" class="display-none">
                <div class="clearFix">
                    ...
                    <div id="emailMessageContainer" class="display-none">
                        <div id="emailActivationText" class="display-none">
                            <%= String.Format(Resource.MessageSendEmailActivationInstructionsOnEmail, "<a name='userEmail'></a>")%>
                        </div>
                        <div id="emailChangeText" class="display-none">
                            <%= String.Format(Resource.MessageSendEmailChangeInstructionsOnEmail, "<a name='userEmail'></a>")%>
                        </div>
                        <div id="resendInviteText" class="display-none">
                            <%= String.Format(Resource.MessageReSendInviteInstructionsOnEmail, "<a name='userEmail'></a>")%>
                        </div>
                    </div>
                </div>
                ...
                <div id="pwd_rem_action_loader" class="clearFix userWaitMes">
