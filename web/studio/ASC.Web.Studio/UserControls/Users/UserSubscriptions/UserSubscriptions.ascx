        ...
        <div class="tabs-block">
          <div class="subscribe-link">
            {{if item.CanUnSubscribe}}
              <a class="unsubscribe baseLinkAction" href="javascript:CommonSubscriptionManager.UnsubscribeProduct('${item.Id}');"><%=Resources.Resource.UnsubscribeButton%></a>
              <span> <%=Resources.Resource.SubscriptionFromAll%> ${item.Name}</span>
            {{/if}}
          </div>
            <span class="float-left"><%=Resources.Resource.SubscriptionNoticeVia%> </span>
