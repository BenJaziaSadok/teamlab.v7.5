...
<div id="inviteResender" style="display: none;">
    <sc:Container ID="_invitesResenderContainer" runat="server">
        ...
        <div id="resendInvitesResult" class="display-none">
            <div id="resendInvitesResultText"></div>
            <div class="clearFix middle-button-container">
                <a id="resendInvitesCloseBtn" class="button gray middle" href="javascript:void(0);"><%=Resources.Resource.CloseButton%></a>
            </div>
        </div>
        </Body>
    </sc:Container>
