...
<script type="text/javascript" src="<%=ResolveUrl("~/js/third-party/jquery/jquery.scrollTo.js") %>"></script>
<script type="text/javascript" src="<%=ResolveUrl("~/js/third-party/jquery/jquery.colors.js") %>"></script>

<script type="text/javascript" src="<%=ResolveUrl("~/js/third-party/jquery/jquery.colorbox.js") %>"></script>

<script type="text/javascript" src="<%=ResolveUrl("~/js/asc/plugins/jquery.helper.js") %>"></script>

<script type="text/javascript" src="<%=ResolveUrl("~/js/asc/core/asc.anchorcontroller.js") %>"></script>
<script type="text/javascript" src="<%=ResolveUrl("~/js/asc/core/common.js") %>"></script>
<script type="text/javascript" src="<%=ResolveUrl("~/js/asc/plugins/jquery.dropdownToggle.js") %>"></script>
<script type="text/javascript" src="<%=ResolveUrl("~/js/asc/core/asc.topstudiopanel.js") %>"></script>
