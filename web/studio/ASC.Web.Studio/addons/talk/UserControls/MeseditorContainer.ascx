...
<div id="talkMeseditorContainer" class="disabled">
  ...
  <div id="talkTextareaContainer">
    <ul class="textareas">
      <li class="textarea default"><iframe src="about:blank"></iframe></li>
    </ul>
  </div>
  ...
  <div id="talkMeseditorToolbarContainer">
    <div class="toolbar" unselectable="on">
      <div class="button-container emotions" title="<%=TalkResource.HintEmotions%>" unselectable="on">
      ...
      <div class="button-container send-file" id="talkFileUploader" title="<%=TalkResource.HintSendFile%>" unselectable="on"><su:ProgressFileUploader runat="server" ID="TalkFileUploader"></su:ProgressFileUploader></div>
      <asp:PlaceHolder ID="talkHistoryButton" runat="server">
        <div class="button-container history" title="<%=TalkResource.HintHistory%>" unselectable="on"><div class="button-talk history" unselectable="on"></div></div>
      </asp:PlaceHolder>
    ...
    <div id="talkSendMenu">
      <div class="left-side"></div>
      <div class="right-side"></div>
      <div class="button-label send-message" title="<%=TalkResource.HintSendMessage%>" unselectable="on"><%=TalkResource.LabelSend%></div>
      <div class="button-talk send-message" title="<%=TalkResource.HintSendMessage%>" unselectable="on"></div>
    </div>
  </div>
</div>
