...
<asp:Content ContentPlaceHolderID="WikiContents" runat="Server">
   <asp:PlaceHolder ID="WikiSideHolder" runat="server"> 
    <div class="WikiHeaderBlock" style="margin-bottom: 16px;">
            <span class="header-with-menu"><%=HttpUtility.HtmlEncode(WikiPageName)%></span>
    ...
    <div class="editCommandPanel clearFix" style="display: none;" id="action_loader">
        <div class="text-medium-describe" id="action_loaderLabel">
            <%=WikiResource.PleaseWaitMessage%>
        </div>
        <div class="text-medium-describe" id="action_loaderErrorMessage" style="display: none;">
            &nbsp;</div>
