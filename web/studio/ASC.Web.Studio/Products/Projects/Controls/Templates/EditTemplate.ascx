...
<div class="templTitle headerPanelSmall"><%=Templ != null ? ProjectTemplatesResource.EditTmplStructure : ProjectTemplatesResource.TemplateStructure %></div>
...
<% if (Templ != null)
   {%>
    <div  class="buttonContainer big-button-container">
        <a id="saveTemplate" class="button blue big"><%=ProjectTemplatesResource.SaveChanges %></a>
        <span class="splitter-buttons"></span>
        <a id="createProject" href="projectTemplates.aspx?id=<%=Templ.Id%>&action=add" class="button gray big"><%= ProjectTemplatesResource.CreateProjFromTmpl %></a>
        <span class="splitter-buttons"></span>
        <a class="button gray big" href="projectTemplates.aspx"><%=ProjectsCommonResource.Cancel%></a>
    </div>
<% }else
   {%>
    <div  class="buttonContainer big-button-container">
        <a id="saveTemplate" class="button blue big"><%=ProjectTemplatesResource.SaveTemplate %></a>
        <span class="splitter-buttons"></span>
        <a id="createProject" href="javascript:void(0)" class="button gray big"><%= ProjectTemplatesResource.SaveAndCreateProjFromTmpl %></a>
        <span class="splitter-buttons"></span>
        <a class="button gray big" href="projectTemplates.aspx"><%=ProjectsCommonResource.Cancel%></a>
    </div>
   <%} %>
