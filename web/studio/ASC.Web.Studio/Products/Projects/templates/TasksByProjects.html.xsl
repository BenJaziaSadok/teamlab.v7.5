        ...
        <tbody>
          ...
          <xsl:for-each select="//r[generate-id() = generate-id(key('g1', @c0))]" >
            ...
            <xsl:for-each select="key('g1', $proj) [generate-id() = generate-id(key('g2', concat($proj, '|', @c2)))]">
              ...
              <tr>
                 <td class='borderBase' style='width:74%;padding-left:32px;'>
                  <div style='width:99%;overflow:hidden;'>
                    <xsl:if test="@c2 = '0'">
                ...
                <td class='borderBase' style='width:10%;'>
                    <div style='width:10%;overflow:hidden;font-size: 14px;'>
                    <span class='{@c15}'>
              ...
              <xsl:for-each select="key('g2', $prjMil) [generate-id() = generate-id(key('g3', concat($prjMil, '|', @c6)))]">
                ...
                <tr>
                  <td class="borderBase" style="width:74%;padding-left:56px;">
                    <div style='width:99%;overflow:hidden;'>
                      <xsl:if test="@c16 = '2'">
            ...
            <xsl:if test="count(//r[generate-id() = generate-id(key('g1', @c0))]) = 0">
              <tr>
                <td colspan='3' class='borderBase' style='width:100%;padding-left:32px;'>
