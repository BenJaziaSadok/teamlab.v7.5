...
<asp:Content ID="PageContent" ContentPlaceHolderID="BTPageContent" runat="server">
    ...
    <div class="pm-headerPanel-splitter clearFix">
        <div class="pm-projectTeam-projectLeaderCard" style="float:left;">
            ...
            <div class="manager-info" data-manager-guid = "<%=Manager.ID %>">
                <div><a class="linkHeaderLight" href="<%=ManagerProfileUrl %>"><%=ManagerName%></a></div>
        ...
        <div style="margin-left: 380px;padding: 0 20px;">
            ...
            <div class="popup_helper" id="AnswerForPrivateProjectTeam">
                ...
                <a target="_blank" href="http://helpcenter.teamlab.com/gettingstarted/projects.aspx#ManagingYourTeam_block"> <%= ProjectsCommonResource.LearnMoreLink %></a></p>
            </div> 
    ...
    <div class="pm-headerPanel-splitter">
        ...
        <div class="pm-projectTeam-container" id="button">
            <a class="button blue middle" onclick="javascript:UserSelector.ShowDialog();"><%= ProjectResource.ManagmentTeam %></a>    
        </div>
        <% } %>
    </div>
   <% if (CanEditTeam) {%>
    <table id="team_container" class="pm-headerPanel-splitter listContainer">
    </table>
   <% }else
      {%>
    <table id="team_container" class="pm-headerPanel-splitter no-access listContainer">
    </table>         
   <% } %>     
    ...
    <% { %>
    <div class="pm-projectTeam-container" id="button">
        <asp:PlaceHolder runat="server" ID="_phTeamSelector" />  
    </div>
    <% } %>
