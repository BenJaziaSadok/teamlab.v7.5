...
<asp:Content ID="PageContent" ContentPlaceHolderID="BTPageContent" runat="server">  
    ...
    <div class="addition mainPageLayout">
        <div class="filter-container">
            ...
            <div class="task-filter-container">
                <a class="link underline" href="tasks.aspx?prjID=<%=Project.ID%>" target="_blank"><%=ProjectsJSResource.ToTaskList %></a>
            </div>
        </div>
    ...
    <div id="ganttHelpPanel" class="studio-action-panel gantt-legend gantt-context-menu">
        ...
        <a class="link underline blue to-full-help" href="http://helpcenter.teamlab.com/projects.aspx" target="_blank"><%=ProjectResource.GanttSeeFullGuide %></a>
    ...
    <div id="emptyScreenForGantt" class="gantt-empty-screen popupContainerClass display-none">
        <div id="hideEmptyScreen" class="cancelButton"></div>
        ...
        <div class="small-button-container">
            <p id="addFirstTask" class="icon-link plus"><a class="baseLinkAction"><%=TaskResource.AddFirstTask%></a></p>
            <p id="addFirstMilestone" class="icon-link plus"><a class="baseLinkAction"><%=MilestoneResource.PlanFirstMilestone%></a></p>
        </div>
    </div>
