    ...
    <table id="quickAddSubTaskField" class="add-subtask-field-wrapper display-none" >
        <tr>    
            <td class="subtask-name border-style">
                <input class="subtask-name-input" type="text" value="${title}" data-subtaskid="${subtaskid}" data-taskid="${taskid}" data-projectid="${projectid}" />
            </td>
...
<script id="projects_subtaskDescribePanelTmpl" type="text/x-jquery-tmpl">
    <div id="subTaskDescrPanel" class="studio-action-panel" objid="">
