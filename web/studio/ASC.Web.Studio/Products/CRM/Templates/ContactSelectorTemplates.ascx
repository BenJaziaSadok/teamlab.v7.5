...
<div id="selectorContent_${ObjID}" style="position:relative;margin-bottom:10px;{{if ShowOnlySelectorContent===false&&selectedContact != null}}display:none;{{/if}}">
        ...
        <tbody>
            <tr>
                ...
                <td class="borderBase" style="border-left: 0 none; border-right: 0 none;">
                    <input type="text" id="contactTitle_${ObjID}" value="{{if selectedContact != null}}${selectedContact.displayName}{{/if}}" class="textEdit" autocomplete="off"/>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <a class="crm-editLink" title="<%= CRMCommonResource.UnlinkContact%>" onclick="window.${ObjName}.changeContact('${ObjID}');">
                        &nbsp;
                    </a>
                    {{/if}}
        ...
        <tbody>
            <tr>
                ...
                <td class="name-container-block">
                    <span class="splitter">
                    {{if ShowNewCompanyContent === true}}
                        <input type="text" id="newCompanyTitle_${ObjID}" class="textEdit" autocomplete="off"/>
                    {{/if}}
                    {{if ShowNewContactContent === true}}
                        <input type="text" id="newContactFirstName_${ObjID}" class="textEdit" autocomplete="off" style="display:none;"/>
                        <input type="text" id="newContactLastName_${ObjID}" class="textEdit" autocomplete="off" style="display:none;"/>
                    {{/if}}
                    </span>
