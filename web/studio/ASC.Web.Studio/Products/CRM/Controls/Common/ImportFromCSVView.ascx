                       ...
                       <div>
                        <span style="float: left;">
                            <%= CRMCommonResource.SampleValues %>:
                                ...
                                class="linkAction" href="javascript:void(0)" onclick="javascript:ASC.CRM.ImportEntities.getPrevSampleRow()"
                                style="display: none">
                                <%= CRMCommonResource.PrevSample %></a><span class="splitter" style="display: none;">|</span><a
                                    class="linkAction" href="javascript:void(0)" onclick="javascript:ASC.CRM.ImportEntities.getNextSampleRow();"
