...
<div id="crm_caseMakerDialog">
    ...
    <div class="crm-actionButtonsBlock">
        ...
        <asp:HyperLink runat="server" CssClass="button gray big" ID="cancelButton"> <%= CRMCommonResource.Cancel%></asp:HyperLink>
    ...
    <div class="crm-actionProcessInfoBlock">
        ...
        <br />
        <img alt="<%= TargetCase == null ? CRMCasesResource.CreateCaseProggress : CRMCommonResource.SaveChangesProggress%>"
            title="<%= TargetCase == null ? CRMCasesResource.CreateCaseProggress : CRMCommonResource.SaveChangesProggress %>"
