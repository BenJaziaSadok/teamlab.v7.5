...
<div id="crm_contactMakerDialog">
    ...
    <div class="crm-actionButtonsBlock">
        ...
        <span class="splitter-buttons"></span>
         <% } %>
        <asp:LinkButton runat="server" ID="cancelButton" class="button gray big"><%= CRMCommonResource.Cancel%></asp:LinkButton>
...
<div id="divSMProfilesWindow" class="borderBase">
    ...
    <div class="divSMProfilesWindowBody mobile-overflow">
        ...
        <div class="divWait">
            <span class="text-medium-describe"><%= CRMSocialMediaResource.PleaseWait%></span>
            <br />
