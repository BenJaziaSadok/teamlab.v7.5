...
using ASC.SocialMedia.TwitterDataProvider;

namespace ASC.Web.CRM.Controls.SocialMedia
{
    public partial class ListUserInfoView : System.Web.UI.UserControl
    {
        ...
        protected void _ctrlRptrUsers_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            string _ctrlRelateAccountScript = String.Format("ASC.CRM.SocialMedia.ShowAccountRelationPanel('{0}'); return false;", userID);
