...
<div id="sendEmailPanel" style="display:none;">
    <div id="createContent">
        ...
        <div class="headerPanel-splitter">
            ...
            <select id="emailTagTypeSelector" onchange="ASC.CRM.SmtpSender.renderTagSelector()">
        ...
        <div class="headerPanel-splitter requiredField">
            ...
            <% if (!MobileVer) { %>
            <asp:PlaceHolder ID="phFckEditor" runat="server"></asp:PlaceHolder>
            <% } else { %>
        ...
        <div class="clearFix">
            ...
            <div style="float:right;">
                <a class="attachLink baseLinkAction linkMedium" onclick="javascript:jq('#attachOptions').show(); jq(this).hide().next().show();" >
                    <%= CRMCommonResource.ShowAttachPanel%>
                </a>
                <a class="attachLink baseLinkAction linkMedium" onclick="javascript:jq('#attachOptions').hide();jq(this).hide().prev().show();" style="display: none;" >
    ...
    <div class="crm-actionProcessInfoBlock">
        ...
        <img src="<%= WebImageSupplier.GetAbsoluteWebPath("ajax_progress_loader.gif") %>" alt=""/>
    </div>
</div>
