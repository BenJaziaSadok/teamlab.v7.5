...
<div>
    <a class="link dotline blue plus" onclick="ASC.CRM.TaskTemplateView.showTemplateConatainerPanel();" >
    ...
    <sc:Container ID="_templateConatainerPanel" runat="server">
        ...
        <Body>
            ...
            <div style="display: none;" class="ajax_info_block">
                <span class="text-medium-describe"> <%= CRMSettingResource.AddTaskTemplateContainerInProgressing%> </span>
                <br />
    ...
    <sc:Container id="_templatePanel" runat="server">
        ...
        <body>
            ...
            <div class='ajax_info_block' style="display: none;">
                <span class="text-medium-describe"> <%= CRMSettingResource.AddTaskTemplateInProgressing%> </span>
                <br />
