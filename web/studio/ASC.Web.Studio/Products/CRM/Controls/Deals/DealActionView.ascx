...
<div id="crm_dealMakerDialog">
    <div class="deal_info clearFix">
        ...
        <dl class="headerPanelSmall-splitter">
            ...
            <dt class="header-base-small" style="display:none;" id="dealMembersHeader"><%=CRMDealResource.OtherMembersDeal%>:</dt>
            <dd style="display:none;" id="dealMembersBody"></dd>
    ...
    <div class="crm-actionProcessInfoBlock">
        <span class="text-medium-describe"></span>
        <br />
