...
insert ignore into tenants_tenants(id, alias, name, version, creationdatetime, owner_id) values (0, 'localhost', 'TeamLab Office', 75, UTC_TIMESTAMP(), '00000000-0000-0000-0000-000000000ace');
