...
namespace ASC.Xmpp.Core.IO.Compression
{
    ...
    /// <summary>
    ///   This is the DeflaterHuffman class. This class is <i>not</i> thread safe. This is inherent in the API, due to the split of deflate and setInput. author of the original java version : Jochen Hoenicke
    /// </summary>
    public class DeflaterHuffman
    {
        ...
        public class Tree
        {
            ...
            /// </summary>
            /// <exception cref="SharpZipBaseException">No frequencies are non-zero</exception>
