    ...
    public class SIP_TransportLayer
    {
        ...
        internal IPEndPoint Resolve(SIP_Flow flow)
        {
            ...
            SIP_Request optionsRequest = m_pStack.CreateRequest(SIP_Methods.OPTIONS,
                                                                new SIP_t_NameAddress("sip:ping@publicIP.com"),
                                                                new SIP_t_NameAddress("sip:ping@publicIP.com"));
        ...
        internal string GetRecordRoute(string transport)
        {
            foreach (IPBindInfo bind in m_pBinds)
            {
                if (!string.IsNullOrEmpty(bind.HostName))
                {
                    if (bind.Protocol == BindInfoProtocol.TCP && bind.SslMode != SslMode.None &&
        ...
        /// <param name="sender">Sender.</param>
        /// <param name="e">Event data.</param>
        private void m_pTcpServer_SessionCreated(object sender,
                                                 TCP_ServerSessionEventArgs<TCP_ServerSession> e)
        {
        ...
        #region Nested type: SIP_FlowManager
