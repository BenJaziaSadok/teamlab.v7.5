...
namespace ASC.Mail.Net.SIP.Message
{
    ...
    public class SIP_HeaderFieldCollection : IEnumerable
    {
        ...
        {
            get { return m_pHeaderFields[index]; }
        }
        ...
        {
            SIP_HeaderField h = GetFirst(fieldName);
            if (h != null)
            {
                h.Value = value;
            }
        ...
        public void RemoveAll(string fieldName)
        {
            ...
            {
                SIP_HeaderField h = m_pHeaderFields[i];
        ...
        private SIP_HeaderField GetheaderField(string name, string value)
        {
            ...
            {
                return new SIP_SingleValueHF<SIP_t_AuthenticationInfo>("Authentication-Info:",
                                                                       new SIP_t_AuthenticationInfo(value));
            }
            ...
            {
                return new SIP_SingleValueHF<SIP_t_ContentDisposition>("Content-Disposition:",
                                                                       new SIP_t_ContentDisposition(value));
            }
            ...
            {
                return new SIP_SingleValueHF<SIP_t_IdentityInfo>("Identity-Info:",
                                                                 new SIP_t_IdentityInfo(value));
            }
            ...
            {
                return new SIP_SingleValueHF<SIP_t_Challenge>("Proxy-Authenticate:",
                                                              new SIP_t_Challenge(value));
            }
            else if (nameLower == "proxy-authorization")
            {
                return new SIP_SingleValueHF<SIP_t_Credentials>("Proxy-Authorization:",
                                                                new SIP_t_Credentials(value));
            }
            ...
            {
                return new SIP_SingleValueHF<SIP_t_SessionExpires>("Replaces:",
                                                                   new SIP_t_SessionExpires(value));
            }
            ...
            {
                return new SIP_SingleValueHF<SIP_t_SessionExpires>("Session-Expires:",
                                                                   new SIP_t_SessionExpires(value));
            }
            else if (nameLower == "subscription-state")
            {
                return new SIP_SingleValueHF<SIP_t_SubscriptionState>("Subscription-State:",
                                                                      new SIP_t_SubscriptionState(value));
            }
            ...
            {
                return new SIP_SingleValueHF<SIP_t_TargetDialog>("Target-Dialog:",
                                                                 new SIP_t_TargetDialog(value));
            }
